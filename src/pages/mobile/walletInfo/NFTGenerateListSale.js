...
class NFTGenerateListSale extends Component {
                ...
                <div className="pt-4 pl-1 pr-1">
                    ...
                    <div className="pt-4">
                        ...
                        <div className="coloredTd w-100">
                            ...
                            <div className="w-35 pl-0 pr-0 text-center">{title.MintTime}</div>
                        </div>
                        ...
                        <div className="unColoredTd w-100">
                            ...
                            <div className="w-25 pl-0 pr-0 text-center" style={{color : "green"}}>{this.state.status}</div>
                        </div>
...
export default NFTGenerateListSale
