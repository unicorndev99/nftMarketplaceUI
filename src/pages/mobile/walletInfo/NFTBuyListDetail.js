        ...
        return (
            <div className="pt-4 pl-1 pr-1 mt-7">
                <div className="d-flex justify-content-end pb-3 mb-2 pl-3 pr-5 mt-3">
                    <Link to={'/NFTBuyList'} className="btn btn-default btn-mobile-default modal_button_close float-right">{title.Close}</Link>
                </div>
                ...
                <div className="mt-4 mb-4">
                    <div className="coloredTd w-100">
                        ...
                        <div className="w-35 pl-0 pr-0 text-center">{title.BuyCompletionTime}</div>
                    </div>
                    ...
                    <div className="coloredTd w-100">
                        ...
                        <div className="w-25 pl-0 pr-0 text-center">{title.MyBuyingPrice}</div>
                    </div>
