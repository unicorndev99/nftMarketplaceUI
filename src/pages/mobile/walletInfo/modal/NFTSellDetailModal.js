                ...
                <div className="modal-dialog modal-sm">
                    <div className="modal-content p-4 mt-7">
                        <div className="d-flex justify-content-around pb-2  mb-2">
                            <button type="button" className="btn btn-default modal_button modal_button_primary float-right" >{title.Stop}</button>
                        ...
                        <div className="pt-2">
                            ...
                            <div className="unColoredTd">
                                ...
                                <div className="col-md-3 text-center">create</div>
                            </div>
                            <div className="coloredTd">
                        ...
                        <p className="font-weight-bold mt-2" style={{fontWeight : 'bold'}}>{title.History}</p>
