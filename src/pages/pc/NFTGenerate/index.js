...
class NFTGenerate extends Component {
    ...
    componentDidMount() {
        document.title = title.NFTMintTitle;
    }
                        ...
                        <div className="col-md-4 pt-lg-4 pl-0 pr-0">
                            <div className="d-flex justify-content-between pb-4 mb-4" style={{borderBottom : '1px solid lightgrey'}}>
                                ...
                                <div>
                                    ...
                                    <button type="button" className="btn btn-default modal_button modal_button_primary float-right" disabled={!(this.state.fileData && this.state.fileType)} onClick={this.mintNFT.bind(this)}>{title.Mint}</button>
                                </div>
                            </div>
                                                ...
                                                <div className="d-flex justify-content-center mb-3">
                                                    {
                                                        ...
                                                        : <img src="image/pages/walletInfo/upload_icon.png"  onClick={this.onClickUpload.bind(this)} id="upload_img" className="upload_icon cursor-pointer" alt=""/>
                                                    }
                                                </div>
                                                <input type="file" id={'fileupload'} hidden={true} onChange={this.encodeImageFileAsURL.bind(this)} accept=".jpg,.png,.mp4"/>
                                                <p className="text-center mb-1 mt-4">{title.UploadFileType}</p>
                                                <p className="text-center font-weight-bold" style={{fontSize:'16px'}}>{title.UploadVideoORImage}</p>
                                            </div>
                                            :
                            ...
                            <div className="pt-4">
                                ...
                                <input placeholder="Input Name" className="form-control form-control-sm form-control-input" onChange={this.onNameChange}/>
                                <p className="mb-2 mt-3 font-weight-bold">{title.Description}</p>
                                <textarea placeholder="Input description" rows="5" className="form-control form-control-sm form-control-input" onChange={this.onDescriptionChange}/>
                            </div>
                        </div>
                    </div>
                </div>
