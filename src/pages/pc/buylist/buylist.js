...
import NFTSaleModal from "./modal/NFTSaleUpdateDetail";
            ...
            <div>
                <div className="search h-80 w-full">
                    <div className="search_card">
                        ...
                        <input className="rounded-full text text-search font-bold z-20" type="search" placeholder={title.SearchByName} />
                ...
                <div className="d-flex justify-content-center">
                    <div className="NftCard-pane">
                        <BoxTable header={this.state.datableDataHeader} num={5} data={this.state.tableData} state={this.state.isAuthenticated}/>
                    </div>
                </div>
                <NFTSaleModal/>
