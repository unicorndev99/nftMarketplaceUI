...
class SaleUpdate extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            dbID: nftInfo.dbID,
            NFTID: nftInfo.id,
            creationDate: nftInfo.createTime,
            salePrice : 0,
                        ...
                        <div className="col-md-4 pt-lg-4 pl-0 pr-0">
                            <div className="d-flex justify-content-between pb-4 mb-4" style={{borderBottom : '1px solid lightgrey'}}>
                                ...
                                <div>
                                    ...
                                    <button type="button" className="btn btn-default modal_button modal_button_primary float-right" onClick={this.onSellUpdateNFT}>{title.Update}</button>
                                </div>
                            </div>
                            ...
                            <div className="pt-4">
                                ...
                                <div className="col-md-12">
                                    ...
                                    <div className="row modal_info_body">
                                        ...
                                        <div className="col-md-6 pt-3 pb-3 text-center font-weight-bold" style={{color :"green"}}>{title.SaleListComplete}</div> 
